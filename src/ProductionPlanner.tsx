...
export default function ProductionPlanner(){
  ...
  const exportData=()=>{const blob=new Blob([JSON.stringify({version:3,savedAt:new Date().toISOString(),viewMode,sortMode,operators,jobs},null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`CWEM-production-plan-${dateKey(weekStart)}.json`;a.click();URL.revokeObjectURL(a.href);flash("Current plan saved");};
